package com.piwew.core.data.source.local

import com.piwew.core.data.source.local.entity.TourismEntity
import com.piwew.core.data.source.local.room.TourismDao
