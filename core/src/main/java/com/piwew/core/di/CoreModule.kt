package com.piwew.core.di

import androidx.room.Room
import com.piwew.core.data.source.TourismRepository
import com.piwew.core.data.source.local.LocalDataSource
import com.piwew.core.data.source.local.room.TourismDatabase
import com.piwew.core.data.source.remote.RemoteDataSource
import com.piwew.core.data.source.remote.network.ApiService
...
val databaseModule = module {
    ...
    single {
        val passphrase: ByteArray = SQLiteDatabase.getBytes("piwew".toCharArray())
...
val networkModule = module {
    single {
        ...
        val certificatePinner = CertificatePinner.Builder()
            .add(hostname, "sha256/bM6APXrLl78qXhDdbBPtWyXdBbF6mqMr4TOjeTjPQ6s=")
